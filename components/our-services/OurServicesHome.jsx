        ...
        <div className="app-container flex flex-col gap-12 py-10 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="w-full">
            ...
            <p className="mt-6 text-base leading-relaxed text-[#212121]">
              Our amazing team of designers and developers may not be able to sing and dance like Beyoncé, but we can do all of these things...
            </p>
          ...
          <div className="w-full">
            <div className="relative aspect-[4/3] w-full">
              <Image
                src="https://www.creatio.com.au/static/images/img/all-services.svg"
